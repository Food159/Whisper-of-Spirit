...
{
    [Header("FSM")]
    public TeenIdleState teenIdestate;
    public TeenWalkState teenWalkstate;
    public TeenShootState teenShootstate;
    public TeenHappyState teenHappystate;
    TeenState state;
    ...
    private void Start()
    {
        ...
        teenShootstate.Setup(rb2d, anim, this);
        teenHappystate.Setup(rb2d, anim, this);
        state = teenIdestate;
    }
    private void Update()
    {
